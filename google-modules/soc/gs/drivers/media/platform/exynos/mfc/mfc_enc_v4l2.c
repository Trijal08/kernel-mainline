...
/* Query a ctrl */
static __maybe_unused int mfc_enc_queryctrl(struct file *file, void *priv,
...
static __maybe_unused int mfc_enc_g_ctrl(struct file *file, void *priv,
...
static __maybe_unused int mfc_enc_s_ctrl(struct file *file, void *priv,
			 struct v4l2_control *ctrl)
{
	struct mfc_ctx *ctx = fh_to_mfc_ctx(file->private_data);
	int ret = 0;
...
static const struct v4l2_ioctl_ops mfc_enc_ioctl_ops = {
	 ...
	 * ext_ctrls path (g/s/try_ext_ctrls) remains the supported route.
	 */
