...
/*
 * NOTE(mainline): the struct alarm callback now returns void (enum
 * alarmtimer_restart / ALARMTIMER_NORESTART were removed). The handler
 * already re-arms the alarm explicitly via alarm_start_relative().
 */
