...
{
	/*
	 * NOTE(mainline): this emitted the Android-only "clock_set_rate"
	 * systrace counter (clock event class removed from mainline
	 * <trace/events/power.h>). No mainline equivalent; marker dropped.
	 */
}
